...
import persistence.GraphDBHandler;
...
public class GraphDatabaseTest {
	...
	public void prepareTestDatabase() {
		...
		mov1 = new Movie(0, "Godzilla 9000", null, null, "Imagen1");
		mov2 = new Movie(1, "Shakalaka Ultimate 3", null, null, "Imagen2");
		mov3 = new Movie(2, "No la he visto", null, null, "Imagen3");
		mov4 = new Movie(3, "La de la prueba", null, null, "Imagen4");
